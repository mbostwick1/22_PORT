...
}).prototype = getMCSymbolPrototype(lib.headline2_1, new cjs.Rectangle(0,0,640,100), null);
...
}).prototype = getMCSymbolPrototype(lib.headline1_1, new cjs.Rectangle(0,0,640,100), null);
...
}).prototype = getMCSymbolPrototype(lib.bottle2_1, new cjs.Rectangle(0,0,640,100), null);
...
}).prototype = getMCSymbolPrototype(lib.bottle1_1, new cjs.Rectangle(0,0,640,100), null);
...
}).prototype = getMCSymbolPrototype(lib.bodycopy_1, new cjs.Rectangle(0,0,640,100), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.clickTag.setTransform(160,25,1.0666,0.2,0,0,0,150,125);
	...
	this.instance.parent = this;
	this.instance.setTransform(150,215,0.5,0.5,0,0,0,300,250);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(261).to({_off:false},0).to({y:120},34,cjs.Ease.cubicOut).to({regX:300.1,x:150.05,y:125},19,cjs.Ease.none).wait(1));
	...
	this.instance_3.setTransform(150,175,0.5,0.5,0,0,0,300,250);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(121).to({_off:false},0).to({y:125},53,cjs.Ease.cubicOut).wait(1).to({alpha:0},38).wait(102));

	// headline 1
	this.instance_4 = new lib.headline1_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(150,75,0.5,0.5,0,0,0,300,250);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(103).to({_off:false},0).to({y:125},53,cjs.Ease.cubicOut).wait(19).to({alpha:0},38).wait(102));

	// bottle 2
	this.instance_5 = new lib.bottle2_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-50,125,0.5,0.5,0,0,0,300,250);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({_off:false},0).to({x:150},92,cjs.Ease.cubicOut).wait(222));

	// bottle 1
	this.instance_6 = new lib.bottle1_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-50,125,0.5,0.5,0,0,0,300,250);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({_off:false},0).to({x:151.25},92,cjs.Ease.cubicOut).wait(204));

	// BG
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A82C3").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_1.setTransform(160,25);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(315));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-40,-30,361.3,170);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bodycopy.png?1565806191849", id:"bodycopy"},
		{src:"images/bottle1.png?1565806191849", id:"bottle1"},
		{src:"images/bottle2.png?1565806191849", id:"bottle2"},
		{src:"images/cta.png?1565806191849", id:"cta"},
		{src:"images/headline1.png?1565806191849", id:"headline1"},
		{src:"images/headline2.png?1565806191849", id:"headline2"},
		{src:"images/logo.png?1565806191849", id:"logo"}
	],
	preloads: []
};
