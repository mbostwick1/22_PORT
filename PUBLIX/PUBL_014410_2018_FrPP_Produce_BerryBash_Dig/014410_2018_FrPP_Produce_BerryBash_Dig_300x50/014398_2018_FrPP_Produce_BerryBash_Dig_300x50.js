...
// stage content:
(lib._014398_2018_FrPP_Produce_BerryBash_Dig_300x50 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(150,25,320,50);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1526061965450", id:"back"},
		{src:"images/cta.png?1526061965450", id:"cta"},
		{src:"images/logo.png?1526061965450", id:"logo"},
		{src:"images/text1.png?1526061965450", id:"text1"},
		{src:"images/text2.png?1526061965450", id:"text2"}
	],
	preloads: []
};
