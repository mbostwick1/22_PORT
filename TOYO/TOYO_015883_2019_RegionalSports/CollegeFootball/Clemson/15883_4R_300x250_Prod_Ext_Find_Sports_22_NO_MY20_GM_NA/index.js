...
p.nominalBounds = new cjs.Rectangle(0,0,1254,500);


(lib.text2 = function() {
	this.initialize(img.text2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,770,500);
...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(0,0,385,250), null);
...
}).prototype = getMCSymbolPrototype(lib.text1_1, new cjs.Rectangle(0,0,627,250), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3LAyIAAhjMAuXAAAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:145.575,y:65}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A3LAyIAAhjMAuXAAAIAABjg");
	var mask_1_graphics_22 = new cjs.Graphics().p("AreAyIAAhjIW9AAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:145.575,y:75}).wait(22).to({graphics:mask_1_graphics_22,x:193.5,y:71}).wait(13).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("A2LBQIAAifMAsXAAAIAACfg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:148.05,y:55}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("A2LBQIAAifMAsXAAAIAACfg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:148.05,y:39}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-2,0,302,250);
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A46BuIAAjbMAx1AAAIAADbg");
	mask.setTransform(154.55,45);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A46BuIAAjbMAx1AAAIAADbg");
	mask_1.setTransform(154.55,66);
...
p.nominalBounds = new cjs.Rectangle(-4.9,0,311.9,250);
...
(lib.headline1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3gBkIAAjHMAvBAAAIAADHg");
	mask.setTransform(149.55,46);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A3gBkIAAjHMAvBAAAIAADHg");
	mask_1.setTransform(149.55,66);
...
p.nominalBounds = new cjs.Rectangle(-0.9,0,301,250);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(252).to({_off:false},0).wait(1).to({regX:151,scaleX:0.9998,scaleY:0.9998,x:150.95},0).wait(1).to({scaleX:0.9997,scaleY:0.9997,x:151,y:124.95},0).wait(1).to({scaleX:0.9995,scaleY:0.9995,x:150.95,y:125},0).wait(1).to({scaleX:0.9993,scaleY:0.9993,x:151,y:124.95},0).wait(1).to({scaleX:0.9992,scaleY:0.9992,x:150.95,y:125},0).wait(1).to({scaleX:0.999,scaleY:0.999,x:151,y:124.95},0).wait(1).to({scaleX:0.9988,scaleY:0.9988,x:150.95,y:125},0).wait(1).to({scaleX:0.9987,scaleY:0.9986,x:151},0).wait(1).to({scaleX:0.9985,scaleY:0.9985,x:150.95},0).wait(1).to({scaleX:0.9983,scaleY:0.9983,x:151},0).wait(1).to({scaleX:0.9982,scaleY:0.9981,x:150.95,y:124.95},0).wait(1).to({scaleX:0.998,scaleY:0.998,x:151,y:125},0).wait(1).to({scaleX:0.9978,scaleY:0.9978,y:124.95},0).wait(1).to({scaleX:0.9977,scaleY:0.9976,y:125},0).wait(1).to({scaleX:0.9975,scaleY:0.9975},0).wait(1).to({scaleX:0.9974,scaleY:0.9973},0).wait(1).to({scaleX:0.9972,scaleY:0.9971},0).wait(1).to({scaleX:0.997,scaleY:0.997,y:124.95},0).wait(1).to({scaleX:0.9969,scaleY:0.9968,x:151.05,y:125},0).wait(1).to({scaleX:0.9967,scaleY:0.9966,x:151},0).wait(1).to({scaleX:0.9966,scaleY:0.9965,x:151.05},0).wait(1).to({scaleX:0.9964,scaleY:0.9963,x:151},0).wait(1).to({scaleX:0.9962,scaleY:0.9961,x:151.05},0).wait(1).to({scaleX:0.9961,scaleY:0.996,x:151},0).wait(1).to({scaleX:0.9959,scaleY:0.9958,x:151.05},0).wait(1).to({scaleX:0.9958,scaleY:0.9957,x:151},0).wait(1).to({scaleX:0.9956,scaleY:0.9955,x:151.05},0).wait(1).to({scaleX:0.9955,scaleY:0.9954,x:151},0).wait(1).to({scaleX:0.9953,scaleY:0.9952,x:151.05},0).wait(1).to({scaleX:0.9952,scaleY:0.9951,x:151},0).wait(1).to({scaleX:0.9951,scaleY:0.9949,x:151.05},0).wait(1).to({scaleX:0.9949,scaleY:0.9948},0).wait(1).to({scaleX:0.9948,scaleY:0.9947,y:125.05},0).wait(1).to({scaleX:0.9947,scaleY:0.9945,y:125},0).wait(1).to({scaleX:0.9945,scaleY:0.9944,x:151},0).wait(1).to({scaleX:0.9944,scaleY:0.9943,x:151.05,y:125.05},0).wait(1).to({scaleX:0.9943,scaleY:0.9941,y:125},0).wait(1).to({scaleX:0.9941,scaleY:0.994},0).wait(1).to({scaleX:0.994,scaleY:0.9939,y:125.05},0).wait(1).to({scaleX:0.9939,scaleY:0.9938,x:151.1,y:125},0).wait(1).to({scaleX:0.9938,scaleY:0.9936,x:151.05},0).wait(1).to({scaleX:0.9937,scaleY:0.9935,y:125.05},0).wait(1).to({scaleX:0.9936,scaleY:0.9934,x:151.1,y:125},0).wait(1).to({scaleX:0.9934,scaleY:0.9933,x:151.05},0).wait(1).to({scaleX:0.9933,scaleY:0.9932},0).wait(1).to({scaleX:0.9932,scaleY:0.9931,y:125.05},0).wait(1).to({scaleX:0.9931,scaleY:0.993,y:125},0).wait(1).to({scaleX:0.993,scaleY:0.9928},0).wait(1).to({scaleX:0.9929,scaleY:0.9927,x:151.1,y:125.05},0).wait(1).to({scaleX:0.9928,scaleY:0.9926,x:151.05},0).wait(1).to({scaleX:0.9927,scaleY:0.9925,y:125},0).wait(1).to({scaleX:0.9926,scaleY:0.9924,x:151.1},0).wait(1).to({scaleX:0.9925,x:151.05,y:125.05},0).wait(1).to({scaleX:0.9924,scaleY:0.9923},0).wait(1).to({scaleY:0.9922,x:151.1,y:125},0).wait(1).to({scaleX:0.9923,scaleY:0.9921},0).wait(1).to({scaleX:0.9922,scaleY:0.992,x:151.05,y:125.05},0).wait(1).to({scaleX:0.9921,scaleY:0.9919},0).wait(1).to({scaleX:0.992,scaleY:0.9918,x:151.1},0).wait(1).to({scaleX:0.9919,scaleY:0.9917,y:125},0).wait(1).to({x:151.05},0).wait(1).to({scaleX:0.9918,scaleY:0.9916,y:125.05},0).wait(1).to({scaleX:0.9917,scaleY:0.9915,x:151.1},0).wait(1).to({scaleX:0.9916,scaleY:0.9914},0).wait(1).to({y:125},0).wait(1).to({scaleX:0.9915,scaleY:0.9913,x:151.05},0).wait(1).to({scaleX:0.9914,scaleY:0.9912,x:151.1,y:125.05},0).wait(2).to({scaleX:0.9913,scaleY:0.9911},0).wait(1).to({scaleX:0.9912,scaleY:0.991},0).wait(1).to({x:151.05,y:125},0).wait(1).to({scaleX:0.9911,scaleY:0.9909,x:151.1},0).wait(2).to({scaleX:0.991,scaleY:0.9908,y:125.05},0).wait(1).to({scaleY:0.9907},0).wait(1).to({scaleX:0.9909},0).wait(1).to({scaleY:0.9906},0).wait(1).to({scaleX:0.9908,y:125},0).wait(1).to({scaleY:0.9905},0).wait(1).to({scaleX:0.9907},0).wait(1).to({scaleY:0.9904,y:125.05},0).wait(1).to({scaleX:0.9906},0).wait(2).to({scaleX:0.9905,scaleY:0.9903},0).wait(2).to({scaleY:0.9902},0).wait(1).to({scaleX:0.9904,y:125},0).wait(2).to({scaleY:0.9901},0).wait(1).to({scaleX:0.9903,y:125.05},0).wait(2).to({scaleY:0.99},0).wait(1).to({scaleX:0.9902},0).wait(2).to({scaleY:0.9899},0).wait(1).to({scaleX:0.9901},0).wait(3).to({scaleY:0.9898},0).wait(1).to({scaleX:0.99,y:125},0).wait(3).to({scaleY:0.9897},0).wait(1).to({regX:150.2,x:150.2},0).to({_off:true},1).wait(101));
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("A18LVIAAowMA4iAAAIAAIwgEgiwgD0IAAngMBFhAAAIAAHgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:148.575,y:96.525}).wait(25).to({graphics:null,x:0,y:0}).wait(211));
	...
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("A18L9IAAowMA4iAAAIAAIwgEgiwgEcIAAngMBFhAAAIAAHgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:148.575,y:147.525}).wait(25).to({graphics:null,x:0,y:0}).wait(211));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(12).to({x:224.5,alpha:0.8594},0).wait(4).to({x:219.5,alpha:1},0).wait(6).to({x:216.5},0).wait(3).to({x:221.5},0).wait(9).to({x:71.5,y:45},0).to({_off:true},16).wait(408));
	...
	this.instance_19.setTransform(221.5,125,1,1,0,0,0,251.5,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(10).to({x:201.5},0).wait(5).to({x:274.5,alpha:0.7305},0).wait(5).to({x:191.5,alpha:1},0).wait(5).to({x:221.5},0).wait(9).to({x:71.5,y:45},0).wait(5).to({x:39.5},0).wait(7).to({x:91.5,alpha:0.7305},0).to({_off:true},4).wait(408));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1595010149488", id:"back1"},
		{src:"images/back2.jpg?1595010149488", id:"back2"},
		{src:"images/cta.png?1595010149488", id:"cta"},
		{src:"images/headline11.png?1595010149488", id:"headline11"},
		{src:"images/headline12.png?1595010149488", id:"headline12"},
		{src:"images/headline21.png?1595010149488", id:"headline21"},
		{src:"images/headline22.png?1595010149488", id:"headline22"},
		{src:"images/headline31.png?1595010149488", id:"headline31"},
		{src:"images/headline32.png?1595010149488", id:"headline32"},
		{src:"images/headline33.png?1595010149488", id:"headline33"},
		{src:"images/logo.png?1595010149488", id:"logo"},
		{src:"images/player.jpg?1595010149488", id:"player"},
		{src:"images/runner.png?1595010149488", id:"runner"},
		{src:"images/text1.png?1595010149488", id:"text1"},
		{src:"images/text2.png?1595010149488", id:"text2"},
		{src:"images/toyota.png?1595010149488", id:"toyota"}
	],
	preloads: []
};
