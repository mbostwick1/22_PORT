...
p.nominalBounds = new cjs.Rectangle(0,0,640,173);
...
}).prototype = getMCSymbolPrototype(lib.candy_1, new cjs.Rectangle(0,0,320,86.5), null);
...
(lib._015141_2018_GrPP_Candy_Halloween_320x50 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:300},35,cjs.Ease.quartOut).wait(1).to({y:365,alpha:0},51,cjs.Ease.quartOut).wait(90));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905153637", id:"back"},
		{src:"images/candy.png?1537905153637", id:"candy"},
		{src:"images/cta.png?1537905153637", id:"cta"},
		{src:"images/logo.png?1537905153637", id:"logo"},
		{src:"images/text1.png?1537905153637", id:"text1"},
		{src:"images/text2.png?1537905153637", id:"text2"}
	],
	preloads: []
};
