...
p.nominalBounds = new cjs.Rectangle(0,0,1456,282);
...
}).prototype = getMCSymbolPrototype(lib.candy_1, new cjs.Rectangle(0,0,728,141), null);
...
(lib._015141_2018_GrPP_Candy_Halloween_728x90 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(80,160,1,1,0,0,0,80,300);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905135223", id:"back"},
		{src:"images/candy.png?1537905135223", id:"candy"},
		{src:"images/cta.png?1537905135223", id:"cta"},
		{src:"images/logo.png?1537905135223", id:"logo"},
		{src:"images/text1.png?1537905135223", id:"text1"},
		{src:"images/text2.png?1537905135223", id:"text2"}
	],
	preloads: []
};
