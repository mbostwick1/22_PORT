...
(lib.GIRL = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(61).to({_off:false},0).to({_off:true},29).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).to({_off:true},30).wait(60).to({_off:false},0).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(59).to({_off:false},0).to({_off:true},31).wait(61));
...
// stage content:
(lib._012151_2018_GML_HERS_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(106).to({_off:false},0).to({x:150},37,cjs.Ease.cubicOut).wait(26));

	// girl
	this.GIRL = new lib.GIRL();
	this.GIRL.name = "GIRL";
	this.GIRL.parent = this;
	this.GIRL.setTransform(150,618,1,1,0,0,0,150,300);
	this.GIRL._off = true;

	this.timeline.addTween(cjs.Tween.get(this.GIRL).wait(106).to({_off:false},0).to({y:300},37,cjs.Ease.quadOut).wait(26));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1523633526344", id:"back"},
		{src:"images/cake.png?1523633526344", id:"cake"},
		{src:"images/girl1.png?1523633526344", id:"girl1"},
		{src:"images/girl2.png?1523633526344", id:"girl2"},
		{src:"images/girl3.png?1523633526344", id:"girl3"},
		{src:"images/logo.png?1523633526344", id:"logo"},
		{src:"images/text1.png?1523633526344", id:"text1"},
		{src:"images/text2.png?1523633526344", id:"text2"},
		{src:"images/text3.png?1523633526344", id:"text3"},
		{src:"images/text4.png?1523633526344", id:"text4"}
	],
	preloads: []
};
