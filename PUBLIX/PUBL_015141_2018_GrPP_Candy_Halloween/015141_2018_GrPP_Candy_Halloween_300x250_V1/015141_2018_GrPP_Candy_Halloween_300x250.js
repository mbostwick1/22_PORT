...
(lib._015141_2018_GrPP_Candy_Halloween_300x250 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(35).to({_off:false},0).to({x:80},35,cjs.Ease.quartOut).wait(1).to({x:237},35,cjs.Ease.quartOut).wait(56));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905198470", id:"back"},
		{src:"images/candy.png?1537905198470", id:"candy"},
		{src:"images/cta.png?1537905198470", id:"cta"},
		{src:"images/logo.png?1537905198470", id:"logo"},
		{src:"images/text1.png?1537905198470", id:"text1"},
		{src:"images/text2.png?1537905198470", id:"text2"}
	],
	preloads: []
};
