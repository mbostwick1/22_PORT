...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(0,0,503,250), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A2uBkIAAjHMAtdAAAIAADHg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:151.475,y:65}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A2uBkIAAjHMAtdAAAIAADHg");
	var mask_1_graphics_22 = new cjs.Graphics().p("AreAyIAAhjIW9AAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:151.475,y:45}).wait(22).to({graphics:mask_1_graphics_22,x:193.5,y:71}).wait(13).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("A2VDmIAAigMAtTAAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:147.0041,y:23}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("A2VCWIAAifMAtTAAAIAACfg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:147.0041,y:15}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A1LEOIAAjcMAtKAAAIAADcg");
	mask.setTransform(153.517,27);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A1LF3IAAjcMAtKAAAIAADcg");
	mask_1.setTransform(153.517,37.5);
...
(lib.headline1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A0YETIAAjIMAshAAAIAADIg");
	mask.setTransform(154.5,27.5);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A0YF3IAAjIMAshAAAIAADIg");
	mask_1.setTransform(154.5,37.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,309,250);
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("Egi+AH+IAAovMBF9AAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:160.1,y:51}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(76.2,95,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({x:72.2},0).wait(9).to({x:76.2},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("Egi+AMRIAAowMBF9AAAIAAIwg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:160.1,y:78.5}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(76.2,95,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:69.2},0).wait(4).to({x:87.2},0).wait(6).to({x:66.2,alpha:0.7891},0).wait(4).to({x:76.2,alpha:1},0).to({_off:true},7).wait(211));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1595279572635", id:"back1"},
		{src:"images/back2.jpg?1595279572635", id:"back2"},
		{src:"images/cta.png?1595279572635", id:"cta"},
		{src:"images/headline11.png?1595279572635", id:"headline11"},
		{src:"images/headline12.png?1595279572635", id:"headline12"},
		{src:"images/headline21.png?1595279572635", id:"headline21"},
		{src:"images/headline22.png?1595279572635", id:"headline22"},
		{src:"images/headline32.png?1595279572635", id:"headline32"},
		{src:"images/headline33.png?1595279572635", id:"headline33"},
		{src:"images/logo.png?1595279572635", id:"logo"},
		{src:"images/player.jpg?1595279572635", id:"player"},
		{src:"images/runner.png?1595279572635", id:"runner"},
		{src:"images/text1.png?1595279572635", id:"text1"},
		{src:"images/text2.png?1595279572635", id:"text2"},
		{src:"images/toyota.png?1595279572635", id:"toyota"}
	],
	preloads: []
};
