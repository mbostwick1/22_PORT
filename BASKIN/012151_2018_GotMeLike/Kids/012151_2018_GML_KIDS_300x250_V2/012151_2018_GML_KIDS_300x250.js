...
(lib._012151_2018_GML_KIDS_300x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(56.1,138.1,0.479,0.479,0,0,0,56.2,138.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(131).to({_off:false},0).to({regX:56,regY:138,scaleX:1,scaleY:1,x:56,y:138,alpha:1},46,cjs.Ease.elasticOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(73).to({_off:false},0).to({x:150},40,cjs.Ease.cubicOut).wait(65));
	...
	this.instance_2.setTransform(150,551,1,1,0,0,0,150,300);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(79).to({_off:false},0).to({y:300},34,cjs.Ease.cubicOut).wait(65));
	...
	this.timeline.addTween(cjs.Tween.get(this.GIRL).wait(79).to({_off:false},0).to({y:300},34,cjs.Ease.cubicOut).wait(65));

	// text4
	this.instance_3 = new lib.text4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(19.1,-30.9,1,1,-38,0,0,19,135);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:134.9,rotation:1.2,x:19,y:135.9},50,cjs.Ease.quartIn).to({regY:135,rotation:0,y:135},3,cjs.Ease.quartIn).wait(125));

	// text3
	this.instance_4 = new lib.text3_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(134,-12,1,1,32.5,0,0,134,120);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({rotation:-1.7,x:134.1,y:122},50,cjs.Ease.quartIn).to({rotation:0,x:134,y:120},3,cjs.Ease.quartIn).wait(119));

	// text2
	this.instance_5 = new lib.text2_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(18.9,-13.9,1,1,-31.7,0,0,18.9,80);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(12).to({_off:false},0).to({regX:19,regY:80.1,rotation:1,x:19,y:82.1},50,cjs.Ease.quartIn).to({regY:80,rotation:0,y:80},3,cjs.Ease.quartIn).wait(113));

	// text1
	this.instance_6 = new lib.text1_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(131,-34,1,1,25.5,0,0,130.5,53.9);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(20).to({_off:false},0).to({regX:130.6,regY:54,rotation:-0.4,x:131.1,y:56.1},50,cjs.Ease.quartIn).to({regX:130.5,rotation:0,x:131,y:54.1},3,cjs.Ease.quartIn).wait(105));

	// logo
	this.instance_7 = new lib.logo_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(43.1,209.1,0.421,0.421,0,0,0,43.1,209);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:43,scaleX:1,scaleY:1,x:43,y:209,alpha:1},58,cjs.Ease.elasticOut).wait(120));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1526665218896", id:"back"},
		{src:"images/cake.png?1526665218896", id:"cake"},
		{src:"images/cta.png?1526665218896", id:"cta"},
		{src:"images/dude1.png?1526665218896", id:"dude1"},
		{src:"images/dude2.png?1526665218896", id:"dude2"},
		{src:"images/dude3.png?1526665218896", id:"dude3"},
		{src:"images/dude4.png?1526665218896", id:"dude4"},
		{src:"images/logo.png?1526665218896", id:"logo"},
		{src:"images/text1.png?1526665218896", id:"text1"},
		{src:"images/text2.png?1526665218896", id:"text2"},
		{src:"images/text3.png?1526665218896", id:"text3"},
		{src:"images/text4.png?1526665218896", id:"text4"}
	],
	preloads: []
};
