...
}).prototype = getMCSymbolPrototype(lib.headline2_1, new cjs.Rectangle(0,0,600,500), null);
...
}).prototype = getMCSymbolPrototype(lib.headline1_1, new cjs.Rectangle(0,0,600,500), null);
...
}).prototype = getMCSymbolPrototype(lib.bottle2_1, new cjs.Rectangle(0,0,805,500), null);
...
}).prototype = getMCSymbolPrototype(lib.bottle1_1, new cjs.Rectangle(0,0,805,500), null);
...
}).prototype = getMCSymbolPrototype(lib.bodycopy_1, new cjs.Rectangle(0,0,600,500), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(269).to({x:76.9},40,cjs.Ease.cubicOut).wait(6));

	// body copy
	this.instance_2 = new lib.bodycopy_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(150.5,-70.05,0.5,0.5,0,0,0,300,250);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(208).to({_off:false},0).to({x:150,y:125},62,cjs.Ease.cubicOut).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(24).to({_off:false},0).to({x:57.75},92,cjs.Ease.cubicOut).wait(199));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({x:59},92,cjs.Ease.cubicOut).wait(222));
...
p.nominalBounds = new cjs.Rectangle(57.8,-70.1,627.7,321.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bodycopy.png?1565805630632", id:"bodycopy"},
		{src:"images/bottle1.png?1565805630632", id:"bottle1"},
		{src:"images/bottle2.png?1565805630632", id:"bottle2"},
		{src:"images/cta.png?1565805630632", id:"cta"},
		{src:"images/headline1.png?1565805630632", id:"headline1"},
		{src:"images/headline2.png?1565805630632", id:"headline2"},
		{src:"images/logo.png?1565805630632", id:"logo"}
	],
	preloads: []
};
