...
// stage content:
(lib._012151_2018_GML_HIS_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(106).to({_off:false},0).to({x:150},44,cjs.Ease.cubicOut).wait(19));

	// DUDE
	this.GIRL = new lib.DUDE();
	this.GIRL.name = "GIRL";
	this.GIRL.parent = this;
	this.GIRL.setTransform(0,250);
	this.GIRL._off = true;

	this.timeline.addTween(cjs.Tween.get(this.GIRL).wait(106).to({_off:false},0).to({y:0},44,cjs.Ease.cubicOut).wait(19));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1523633461783", id:"back"},
		{src:"images/cake.png?1523633461783", id:"cake"},
		{src:"images/dude1.png?1523633461783", id:"dude1"},
		{src:"images/dude2.png?1523633461783", id:"dude2"},
		{src:"images/logo.png?1523633461783", id:"logo"},
		{src:"images/text1.png?1523633461783", id:"text1"},
		{src:"images/text2.png?1523633461783", id:"text2"},
		{src:"images/text3.png?1523633461783", id:"text3"},
		{src:"images/text4.png?1523633461783", id:"text4"}
	],
	preloads: []
};
