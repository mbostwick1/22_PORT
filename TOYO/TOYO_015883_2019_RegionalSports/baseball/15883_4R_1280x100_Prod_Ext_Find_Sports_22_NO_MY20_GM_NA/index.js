...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EAllAHXIAAh4MAgqAAAIAAB4g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:449.475,y:47.075}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EAllAGbIAAh4MAgqAAAIAAB4g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:449.475,y:41.075}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("A3RBkIAAjHMAujAAAIAADHg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:760.05,y:60.05}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("A3RBkIAAjHMAujAAAIAADHg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:760.05,y:40.05}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_364 = new cjs.Graphics().p("EBL8AFjIAAkYIYEAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(364).to({graphics:mask_graphics_364,x:640,y:35.5}).wait(94));
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_364 = new cjs.Graphics().p("EBL8AHqIAAkYIYEAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(364).to({graphics:mask_1_graphics_364,x:640,y:49}).wait(94));
	...
	var mask_4_graphics_361 = new cjs.Graphics().p("AtgHNIAAuaIbBAAIAAOag");
	...
	var mask_4_graphics_377 = new cjs.Graphics().p("ABCHnIAAvNMAqWAAAIAAPNg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(212).to({graphics:mask_4_graphics_212,x:490.55,y:64.65}).wait(9).to({graphics:null,x:0,y:0}).wait(140).to({graphics:mask_4_graphics_361,x:468.5,y:46.55}).wait(6).to({graphics:mask_4_graphics_367,x:324.75,y:80.475}).wait(6).to({graphics:mask_4_graphics_373,x:371.5,y:20.025}).wait(4).to({graphics:mask_4_graphics_377,x:277.625,y:24.325}).wait(4).to({graphics:null,x:0,y:0}).wait(77));
	...
	mask_5._off = true;
	var mask_5_graphics_179 = new cjs.Graphics().p("AsLIcIAAw4IYXAAIAAQ4g");
	var mask_5_graphics_186 = new cjs.Graphics().p("AsLF/IAAr9IYXAAIAAL9g");
	var mask_5_graphics_190 = new cjs.Graphics().p("AsLFhIAArBIYXAAIAALBg");
	var mask_5_graphics_195 = new cjs.Graphics().p("AsLJeIAAy7IYXAAIAAS7g");
	var mask_5_graphics_204 = new cjs.Graphics().p("AqZFoIAArPIUzAAIAALPg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(179).to({graphics:mask_5_graphics_179,x:898.975,y:53.8}).wait(7).to({graphics:mask_5_graphics_186,x:724.125,y:36.25}).wait(4).to({graphics:mask_5_graphics_190,x:697.425,y:68.475}).wait(5).to({graphics:mask_5_graphics_195,x:853.825,y:47.45}).wait(9).to({graphics:mask_5_graphics_204,x:871.45,y:64.825}).wait(2).to({graphics:null,x:0,y:0}).wait(252));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1583784671528", id:"back1"},
		{src:"images/back2.jpg?1583784671528", id:"back2"},
		{src:"images/cta.png?1583784671528", id:"cta"},
		{src:"images/headline11.png?1583784671528", id:"headline11"},
		{src:"images/headline12.png?1583784671528", id:"headline12"},
		{src:"images/headline21.png?1583784671528", id:"headline21"},
		{src:"images/headline22.png?1583784671528", id:"headline22"},
		{src:"images/headline31.png?1583784671528", id:"headline31"},
		{src:"images/headline32.png?1583784671528", id:"headline32"},
		{src:"images/headline33.png?1583784671528", id:"headline33"},
		{src:"images/logo.png?1583784671528", id:"logo"},
		{src:"images/player.jpg?1583784671528", id:"player"},
		{src:"images/runner.png?1583784671528", id:"runner"},
		{src:"images/text1.png?1583784671528", id:"text1"},
		{src:"images/text2.png?1583784671528", id:"text2"},
		{src:"images/toyota.png?1583784671528", id:"toyota"}
	],
	preloads: []
};
