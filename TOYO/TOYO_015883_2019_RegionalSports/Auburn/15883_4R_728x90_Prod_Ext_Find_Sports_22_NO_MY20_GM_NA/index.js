...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AAyFzIAAi+MAuaAAAIAAC+g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:302,y:37.075}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AAyEUIAAi+MAuaAAAIAAC+g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:302,y:27.575}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
...
p.nominalBounds = new cjs.Rectangle(-10,0,743,94);
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A9aCDIAAkEMA61AAAIAAEEg");
	mask.setTransform(533.75,45.15);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A9aCCIAAkDMA61AAAIAAEDg");
	mask_1.setTransform(533.75,70.075);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:544.05,y:22}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(396.2,116,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({x:392.2},0).wait(9).to({x:396.2},0).to({_off:true},7).wait(211));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:544.05,y:77}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(396.2,116,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:389.2},0).wait(4).to({x:407.2},0).wait(6).to({x:386.2,alpha:0.7891},0).wait(4).to({x:396.2,alpha:1},0).to({_off:true},7).wait(211));
	...
	this.instance_12.setTransform(142,131.5,1,1,0,0,0,150,125);
...
p.nominalBounds = new cjs.Rectangle(300,10.5,561,126.19999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596659770663", id:"back1"},
		{src:"images/back2.jpg?1596659770663", id:"back2"},
		{src:"images/cta.png?1596659770663", id:"cta"},
		{src:"images/headline11.png?1596659770663", id:"headline11"},
		{src:"images/headline12.png?1596659770663", id:"headline12"},
		{src:"images/headline21.png?1596659770663", id:"headline21"},
		{src:"images/headline22.png?1596659770663", id:"headline22"},
		{src:"images/headline31.png?1596659770663", id:"headline31"},
		{src:"images/headline33.png?1596659770663", id:"headline33"},
		{src:"images/logo.png?1596659770663", id:"logo"},
		{src:"images/player.jpg?1596659770663", id:"player"},
		{src:"images/runner.png?1596659770663", id:"runner"},
		{src:"images/text1.png?1596659770663", id:"text1"},
		{src:"images/text2.png?1596659770663", id:"text2"},
		{src:"images/toyota.png?1596659770663", id:"toyota"}
	],
	preloads: []
};
