...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A8MBFIAAiJMA4ZAAAIAACJg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:605.45,y:51.075}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A8MBFIAAiJMA4ZAAAIAACJg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:605.45,y:37.225}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
...
(lib.headline1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A+PBaIAAizMA8fAAAIAACzg");
	mask.setTransform(684.45,36);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A+PBaIAAizMA8fAAAIAACzg");
	mask_1.setTransform(684.45,54);
...
(lib.back2_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:150.1,scaleX:1.0151,scaleY:1.0151,x:152.35,y:119.95},480).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596169769547", id:"back1"},
		{src:"images/back2.jpg?1596169769547", id:"back2"},
		{src:"images/cta.png?1596169769547", id:"cta"},
		{src:"images/headline11.png?1596169769547", id:"headline11"},
		{src:"images/headline12.png?1596169769547", id:"headline12"},
		{src:"images/headline21.png?1596169769547", id:"headline21"},
		{src:"images/headline22.png?1596169769547", id:"headline22"},
		{src:"images/headline31.png?1596169769547", id:"headline31"},
		{src:"images/headline33.png?1596169769547", id:"headline33"},
		{src:"images/logo.png?1596169769547", id:"logo"},
		{src:"images/player.jpg?1596169769547", id:"player"},
		{src:"images/runner.png?1596169769547", id:"runner"},
		{src:"images/text1.png?1596169769547", id:"text1"},
		{src:"images/text2.png?1596169769547", id:"text2"},
		{src:"images/toyota.png?1596169769547", id:"toyota"}
	],
	preloads: []
};
