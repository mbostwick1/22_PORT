...
(lib._012151_2018_GML_KIDS_300x600 = function(mode,startPosition,loop) {
	...
	// DUDE2
	this.instance = new lib.DUDE2();
	this.instance.parent = this;
	this.instance.setTransform(269,300,1,1,0,0,0,150,300);
	...
	this.timeline.addTween(cjs.Tween.get(this.GIRL).wait(106).to({_off:false},0).to({x:150},40,cjs.Ease.cubicOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(106).to({_off:false},0).to({x:150},40,cjs.Ease.cubicOut).wait(1));

	// Cake1
	this.instance_2 = new lib.cake();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-67,300,1,1,0,0,0,150,300);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(106).to({_off:false},0).to({x:150},40,cjs.Ease.cubicOut).wait(1));

	// text4
	this.instance_3 = new lib.text4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(51,-70,1,1,-40,0,0,51,273);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(26).to({_off:false},0).to({regY:273.1,rotation:2,y:274.1},50,cjs.Ease.quartIn).to({regY:273,rotation:0,y:273},3,cjs.Ease.quartIn).wait(68));

	// text3
	this.instance_4 = new lib.text3_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(248,-64,1,1,40,0,0,248,201);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(34).to({_off:false},0).to({regY:201.1,rotation:-2,y:202.1},50,cjs.Ease.quartIn).to({regY:201,rotation:0,y:201},3,cjs.Ease.quartIn).wait(60));

	// text2
	this.instance_5 = new lib.text2_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(56,-41,1,1,-40,0,0,56,160);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(43).to({_off:false},0).to({rotation:2,y:161},50,cjs.Ease.quartIn).to({rotation:0,y:160},3,cjs.Ease.quartIn).wait(51));

	// text1
	this.instance_6 = new lib.text1_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(250,-58,1,1,40,0,0,250,143);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(52).to({_off:false},0).to({rotation:-2,y:144},50,cjs.Ease.quartIn).to({rotation:0,y:143},3,cjs.Ease.quartIn).wait(42));

	// logo
	this.instance_7 = new lib.logo_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150.1,59.1,0.413,0.413,0,0,0,150,59.1);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regY:59,scaleX:1,scaleY:1,x:150,y:59,alpha:1},58,cjs.Ease.elasticOut).wait(89));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1523567749944", id:"back"},
		{src:"images/cake1.png?1523567749944", id:"cake1"},
		{src:"images/cake2.png?1523567749944", id:"cake2"},
		{src:"images/dude1.png?1523567749944", id:"dude1"},
		{src:"images/dude2.png?1523567749944", id:"dude2"},
		{src:"images/dude3.png?1523567749944", id:"dude3"},
		{src:"images/dude4.png?1523567749944", id:"dude4"},
		{src:"images/logo.png?1523567749944", id:"logo"},
		{src:"images/text1.png?1523567749944", id:"text1"},
		{src:"images/text2.png?1523567749944", id:"text2"},
		{src:"images/text3.png?1523567749944", id:"text3"},
		{src:"images/text4.png?1523567749944", id:"text4"}
	],
	preloads: []
};
