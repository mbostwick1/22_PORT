...
p.nominalBounds = new cjs.Rectangle(0,0,1456,324);
...
}).prototype = getMCSymbolPrototype(lib.candy_1, new cjs.Rectangle(0,0,728,162), null);
...
// stage content:
(lib._015141_2018_GrPP_Candy_Halloween_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.kitty_mc.setTransform(79.6,53.1,0.225,0.225,0,0,0,185.2,271.1);
	...
	this.instance.parent = this;
	this.instance.setTransform(639.1,29.1,0.449,0.449,0,0,0,639.1,29.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(124).to({_off:false},0).to({regX:639,regY:29,scaleX:1,scaleY:1,x:639,y:29,alpha:1},35,cjs.Ease.elasticOut).wait(3));

	// candy
	this.instance_1 = new lib.candy_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(80,138,1,1,0,0,0,80,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(35).to({_off:false},0).to({y:286},35,cjs.Ease.quartOut).wait(1).to({y:392},35,cjs.Ease.quartOut).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:300},35,cjs.Ease.quartOut).wait(127));

	// logo
	this.instance_4 = new lib.logo_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(80,281,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(124).to({y:300},26,cjs.Ease.backOut).wait(12));
...
p.nominalBounds = new cjs.Rectangle(363,-45,730,203.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905144929", id:"back"},
		{src:"images/candy.png?1537905144929", id:"candy"},
		{src:"images/cta.png?1537905144929", id:"cta"},
		{src:"images/logo.png?1537905144929", id:"logo"},
		{src:"images/text1.png?1537905144929", id:"text1"},
		{src:"images/text2.png?1537905144929", id:"text2"}
	],
	preloads: []
};
