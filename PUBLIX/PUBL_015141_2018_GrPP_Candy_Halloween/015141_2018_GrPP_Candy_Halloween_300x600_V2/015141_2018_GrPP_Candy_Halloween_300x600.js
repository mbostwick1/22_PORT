...
(lib._015141_2018_GrPP_Candy_Halloween_300x600 = function(mode,startPosition,loop) {
	...
	this.kitty_mc.setTransform(149.6,144,0.461,0.461,0,0,0,185,271.3);
	...
	this.instance_1.setTransform(320,300,1,1,0,0,0,80,300);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905170439", id:"back"},
		{src:"images/candy.png?1537905170439", id:"candy"},
		{src:"images/cta.png?1537905170439", id:"cta"},
		{src:"images/logo.png?1537905170439", id:"logo"},
		{src:"images/text1.png?1537905170439", id:"text1"},
		{src:"images/text2.png?1537905170439", id:"text2"}
	],
	preloads: []
};
