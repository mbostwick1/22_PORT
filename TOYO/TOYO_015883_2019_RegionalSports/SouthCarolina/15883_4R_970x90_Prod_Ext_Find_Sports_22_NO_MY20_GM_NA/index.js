...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EghKAB+IAAj7MBCVAAAIAAD7g");
	mask.setTransform(686.75,45.725);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("EghKAB9IAAj5MBCVAAAIAAD5g");
	mask_1.setTransform(686.75,69.775);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:738.275,y:18.875}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(537.55,108.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({regX:164.3,x:533.85},0).wait(9).to({regX:164.2,x:537.55},0).to({_off:true},7).wait(211));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:738.275,y:74.6}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(537.55,108.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({regX:164.3,x:531.1},0).wait(4).to({x:547.85},0).wait(6).to({regX:164.4,x:528.4,alpha:0.7891},0).wait(4).to({regX:164.2,x:537.55,alpha:1},0).to({_off:true},7).wait(211));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596592661165", id:"back1"},
		{src:"images/back2.jpg?1596592661165", id:"back2"},
		{src:"images/cta.png?1596592661165", id:"cta"},
		{src:"images/headline11.png?1596592661165", id:"headline11"},
		{src:"images/headline12.png?1596592661165", id:"headline12"},
		{src:"images/headline21.png?1596592661165", id:"headline21"},
		{src:"images/headline22.png?1596592661165", id:"headline22"},
		{src:"images/headline31.png?1596592661165", id:"headline31"},
		{src:"images/headline33.png?1596592661165", id:"headline33"},
		{src:"images/logo.png?1596592661165", id:"logo"},
		{src:"images/player.jpg?1596592661165", id:"player"},
		{src:"images/runner.png?1596592661165", id:"runner"},
		{src:"images/text1.png?1596592661165", id:"text1"},
		{src:"images/text2.png?1596592661165", id:"text2"},
		{src:"images/toyota.png?1596592661165", id:"toyota"}
	],
	preloads: []
};
