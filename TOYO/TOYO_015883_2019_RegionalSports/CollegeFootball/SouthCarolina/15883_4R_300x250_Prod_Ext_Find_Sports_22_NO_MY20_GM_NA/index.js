...
p.nominalBounds = new cjs.Rectangle(0,0,687,500);
...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(0,0,343.5,250), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AwAAyIAAhjMAgBAAAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:174.55,y:74}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AwAAyIAAhjMAgBAAAIAABjg");
	var mask_1_graphics_22 = new cjs.Graphics().p("AreAyIAAhjIW9AAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:174.55,y:64}).wait(22).to({graphics:mask_1_graphics_22,x:193.5,y:71}).wait(13).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("AvTEsIAAigMAi/AAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:126,y:30}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("AvTDcIAAigMAi/AAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:126,y:22}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A18BuIAAjbMAr5AAAIAADbg");
	mask.setTransform(166.5,45);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A18BuIAAjbMAr5AAAIAADbg");
	mask_1.setTransform(166.5,66);
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("A9gGVIAAovMA7CAAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:145.1,y:40.5}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(136.2,75,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({x:132.2},0).wait(9).to({x:136.2},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("A9gKoIAAowMA7CAAAIAAIwg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:145.1,y:68}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(136.2,75,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:129.2},0).wait(4).to({x:147.2},0).wait(6).to({x:126.2,alpha:0.7891},0).wait(4).to({x:136.2,alpha:1},0).to({_off:true},7).wait(211));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1595012048008", id:"back1"},
		{src:"images/back2.jpg?1595012048008", id:"back2"},
		{src:"images/cta.png?1595012048008", id:"cta"},
		{src:"images/headline11.png?1595012048008", id:"headline11"},
		{src:"images/headline12.png?1595012048008", id:"headline12"},
		{src:"images/headline21.png?1595012048008", id:"headline21"},
		{src:"images/headline22.png?1595012048008", id:"headline22"},
		{src:"images/headline31.png?1595012048008", id:"headline31"},
		{src:"images/headline32.png?1595012048008", id:"headline32"},
		{src:"images/headline33.png?1595012048008", id:"headline33"},
		{src:"images/logo.png?1595012048008", id:"logo"},
		{src:"images/player.jpg?1595012048008", id:"player"},
		{src:"images/runner.png?1595012048008", id:"runner"},
		{src:"images/text1.png?1595012048008", id:"text1"},
		{src:"images/text2.png?1595012048008", id:"text2"},
		{src:"images/toyota.png?1595012048008", id:"toyota"}
	],
	preloads: []
};
