...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3MBfIAAi9MAuZAAAIAAC9g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:455.5,y:72.65}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A3MBfIAAi9MAuZAAAIAAC9g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:455.5,y:53.65}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("A0xBQIAAifMApjAAAIAACfg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:471,y:41}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("AFoClIAAigMApkAAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:302,y:16.5}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A45CDIAAkEMAxzAAAIAAEEg");
	mask.setTransform(502.65,45.15);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A45CCIAAkDMAxzAAAIAAEDg");
	mask_1.setTransform(502.65,70.075);
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("EgyyAEYIAAovMBllAAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:454.05,y:19}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(306.2,113,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({x:302.2},0).wait(9).to({x:306.2},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("EgyyAEYIAAovMBllAAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:454.05,y:74}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(306.2,113,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:299.2},0).wait(4).to({x:317.2},0).wait(6).to({x:296.2,alpha:0.7891},0).wait(4).to({x:306.2,alpha:1},0).to({_off:true},7).wait(211));
	...
	mask_7._off = true;
	var mask_7_graphics_0 = new cjs.Graphics().p("EguPAE9IAAp5MBwzAAAIAAJ5g");
	var mask_7_graphics_34 = new cjs.Graphics().p("Eg4iAFKIAAqTMBxFAAAIAAKTg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:mask_7_graphics_0,x:426,y:-2.8}).wait(34).to({graphics:mask_7_graphics_34,x:656.05,y:39.025}).wait(16).to({graphics:null,x:0,y:0}).wait(408));
	...
	mask_8._off = true;
	var mask_8_graphics_0 = new cjs.Graphics().p("EguPAHHIAAp5MBwzAAAIAAJ5g");
	var mask_8_graphics_34 = new cjs.Graphics().p("Eg4iAFKIAAqTMBxFAAAIAAKTg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:mask_8_graphics_0,x:426,y:45.5}).wait(34).to({graphics:mask_8_graphics_34,x:656.05,y:103.675}).wait(16).to({graphics:null,x:0,y:0}).wait(408));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596137304923", id:"back1"},
		{src:"images/back2.jpg?1596137304923", id:"back2"},
		{src:"images/cta.png?1596137304923", id:"cta"},
		{src:"images/headline11.png?1596137304923", id:"headline11"},
		{src:"images/headline12.png?1596137304923", id:"headline12"},
		{src:"images/headline21.png?1596137304923", id:"headline21"},
		{src:"images/headline22.png?1596137304923", id:"headline22"},
		{src:"images/headline31.png?1596137304923", id:"headline31"},
		{src:"images/headline32.png?1596137304923", id:"headline32"},
		{src:"images/headline33.png?1596137304923", id:"headline33"},
		{src:"images/logo.png?1596137304923", id:"logo"},
		{src:"images/player.jpg?1596137304923", id:"player"},
		{src:"images/runner.png?1596137304923", id:"runner"},
		{src:"images/text1.png?1596137304923", id:"text1"},
		{src:"images/text2.png?1596137304923", id:"text2"},
		{src:"images/toyota.png?1596137304923", id:"toyota"}
	],
	preloads: []
};
