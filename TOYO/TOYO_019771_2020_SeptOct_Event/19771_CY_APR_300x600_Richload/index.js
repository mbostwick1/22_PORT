...
(lib.CL_side = function() {
	this.initialize(img.CL_side);
}).prototype = p = new cjs.Bitmap();
...
(lib.CY_side = function() {
	this.initialize(img.CY_side);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,600,500);
...
(lib.HI_side = function() {
	this.initialize(img.HI_side);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,600,500);
...
(lib.RV_side = function() {
	this.initialize(img.RV_side);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,600,500);
...
(lib.whiteFrame = function() {
	this.initialize(img.whiteFrame);
}).prototype = p = new cjs.Bitmap();
...
(lib.whiteFrame_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.whiteFrame();
...
}).prototype = getMCSymbolPrototype(lib.whiteFrame_1, new cjs.Rectangle(0,0,300,600), null);
...
(lib.RV_SIDE = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.RV_side();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.RV_SIDE, new cjs.Rectangle(0,0,300,250), null);
...
(lib.offer_mc = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(133.175,9.125);
	...
	this.dynamic_field1.setTransform(44.25,-8.8,1.1202,1.0991);
	...
	this.dynamic_field2.setTransform(148.2427,2.2,1.1202,1.0991);
	...
	this.dynamic_field3.setTransform(148.2286,12.2,1.1202,1.0991);

	this.timeline.addTween(cjs.Tween.get(this.dynamic_field3).wait(1));

	// dynamic_field4
	this.dynamic_field4 = new cjs.Text("PLUS $500 BONUS CASH", "bold 10px 'Toyota Type Black'", "#EA0015");
	this.dynamic_field4.name = "dynamic_field4";
	this.dynamic_field4.textAlign = "center";
	this.dynamic_field4.lineHeight = 11;
	this.dynamic_field4.lineWidth = 159;
	this.dynamic_field4.parent = this;
	this.dynamic_field4.setTransform(142.0321,41.95,1.1202,1.0991);

	this.timeline.addTween(cjs.Tween.get(this.dynamic_field4).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.offer_mc, new cjs.Rectangle(42,-11,290,70.8), null);
...
(lib.HI_side_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.HI_side();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.HI_side_1, new cjs.Rectangle(0,0,300,250), null);
...
(lib.eventLOGO = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.eventLOGO, new cjs.Rectangle(0,0,300,600), null);
...
(lib.CY_side_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.CY_side();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.CY_side_1, new cjs.Rectangle(0,0,300,250), null);
...
(lib.CL_side_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.CL_side();
	this.instance.setTransform(300,0,0.5,0.5,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CL_side_1, new cjs.Rectangle(0,0,300,250), null);
...
(lib.RV_SideOut_mc = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// wheelSpin_mc
	this.instance = new lib.RV_wheelSpinOut_mc();
	this.instance.setTransform(83.4,163.45,0.34,0.34,0,0,0,38,37.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// wheelSpin_mc
	this.instance_1 = new lib.RV_wheelSpinOut_mc();
	this.instance_1.setTransform(214.3,163.45,0.34,0.34,0,0,0,38,37.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// vehicle_mc
	this.instance_2 = new lib.RV_SIDE();
...
}).prototype = getMCSymbolPrototype(lib.RV_SideOut_mc, new cjs.Rectangle(0,0,300,250), null);
...
(lib.CL_SIDEIn_mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// wheelSpin_mc copy
	this.instance = new lib.CL_wheelSpinIn_mc();
	this.instance.setTransform(211.4,165.4,0.2999,0.2999,0,0,180,38,37.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// wheelSpin_mc
	this.instance_1 = new lib.CL_wheelSpinIn_mc();
	this.instance_1.setTransform(92.4,165.4,0.2999,0.2999,0,0,180,38,37.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// vehicle
	this.instance_2 = new lib.CL_side_1();
	this.instance_2.setTransform(150,125,1,1,0,0,0,150,125);
...
}).prototype = getMCSymbolPrototype(lib.CL_SIDEIn_mc, new cjs.Rectangle(0,0,300,250), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(82).call(this.frame_82).wait(116).call(this.frame_198).wait(118).call(this.frame_316).wait(8).call(this.frame_324).wait(45).call(this.frame_369).wait(2).call(this.frame_371).wait(36).call(this.frame_407).wait(79).call(this.frame_486).wait(62).call(this.frame_548).wait(1));
	...
	this.details_btn.setTransform(151,474,1.162,1,0,0,0,18.1,7);
	new cjs.ButtonHelper(this.details_btn, 0, 1, 2, false, new lib.details_btn(), 3);

	this.timeline.addTween(cjs.Tween.get(this.details_btn).wait(549));
	...
	this.timeline.addTween(cjs.Tween.get(this.clickTag).wait(549));

	// eventEnds
	this.instance = new lib.eventEnds_1();
	this.instance.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));

	// offer_mc
	this.offer_mc = new lib.offer_mc();
	this.offer_mc.name = "offer_mc";
	this.offer_mc.setTransform(100,448,1,1,0,0,0,93,44);
	this.offer_mc.alpha = 0;
	this.offer_mc._off = true;

	this.timeline.addTween(cjs.Tween.get(this.offer_mc).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));

	// eventLogo
	this.instance_5 = new lib.eventLOGO();
	this.instance_5.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(504).to({_off:false},0).to({alpha:1},44,cjs.Ease.quadOut).wait(1));

	// hero
	this.CY_mc = new lib.CY_AnimationIn_mc();
	this.CY_mc.name = "CY_mc";
	this.CY_mc.setTransform(415.55,251.9,0.8468,0.8468,0,0,180,150.1,125.4);
	this.CY_mc._off = true;

	this.timeline.addTween(cjs.Tween.get(this.CY_mc).wait(504).to({_off:false},0).to({regX:149.9,regY:125,scaleX:1.0231,scaleY:1.0231,x:150.65,y:266.15},44,cjs.Ease.cubicOut).wait(1));

	// logo
	this.instance_6 = new lib.logo_1();
	this.instance_6.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(486).to({alpha:0},33,cjs.Ease.cubicOut).wait(30));

	// RV_side
	this.instance_7 = new lib.RV_SIDE();
	this.instance_7.setTransform(150,268,1,1,0,0,0,150,125);

	this.instance_8 = new lib.RV_SideOut_mc();
	this.instance_8.setTransform(150,268,1,1,0,0,0,150,125);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},407).to({state:[{t:this.instance_8}]},35).to({state:[{t:this.instance_8}]},44).wait(63));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(442).to({_off:false},0).to({x:-112},44,cjs.Ease.cubicIn).wait(63));

	// CL_side
	this.instance_9 = new lib.CL_SIDEIn_mc();
	this.instance_9.setTransform(431,268,1,1,0,0,180,150,125);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(260).to({_off:false},0).to({x:151},44,cjs.Ease.cubicOut).to({_off:true},32).wait(213));

	// HighlanderOut
	this.instance_10 = new lib.HI_AnimationOut_mc();
	this.instance_10.setTransform(100.7,284.05,0.7626,0.7626,0,0,0,149.9,125.2);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(221).to({_off:false},0).to({regX:150.5,regY:125.5,scaleX:0.938,scaleY:0.938,x:429.15,y:309.2},44,cjs.Ease.cubicIn).to({_off:true},1).wait(283));

	// HighlanderIn
	this.instance_11 = new lib.HI_AnimationIn_mc();
	this.instance_11.setTransform(-96.85,273.3,0.6311,0.6311,0,0,0,149.9,125.5);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(93).to({_off:false},0).to({regY:125.2,scaleX:0.7626,scaleY:0.7626,x:100.7,y:284.05},44,cjs.Ease.cubicOut).to({_off:true},84).wait(328));

	// RAV4Out
	this.instance_12 = new lib.RV_AnimationOut_mc();
	this.instance_12.setTransform(186.25,270,0.4391,0.4391,0,0,0,150.2,125.2);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(213).to({_off:false},0).to({regX:150.1,regY:125.4,scaleX:0.6055,scaleY:0.6055,x:412.25,y:283.8},44,cjs.Ease.cubicIn).to({_off:true},9).wait(283));

	// RAV4In
	this.instance_13 = new lib.RV_AnimationIn_mc();
	this.instance_13.setTransform(0,261,0.3634,0.3634,0,0,0,150.1,125.6);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(103).to({_off:false},0).to({regX:150.2,regY:125.2,scaleX:0.4391,scaleY:0.4391,x:186.25,y:270},44,cjs.Ease.cubicOut).to({_off:true},66).wait(336));

	// CorollaOut
	this.instance_14 = new lib.CL_AnimationOut_mc();
	this.instance_14.setTransform(244.95,265.45,0.2673,0.2673,0,0,0,150.2,125.2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(206).to({_off:false},0).to({regY:125.1,scaleX:0.3393,scaleY:0.3393,x:445.15,y:279.6},44,cjs.Ease.cubicIn).to({_off:true},16).wait(283));

	// CorollaIn
	this.instance_15 = new lib.CL_AnimationIn_mc();
	this.instance_15.setTransform(95,261,0.2212,0.2212,0,0,0,150.3,125.5);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(112).to({_off:false},0).to({regX:150.2,regY:125.2,scaleX:0.2673,scaleY:0.2673,x:244.95,y:265.45},44,cjs.Ease.cubicOut).to({_off:true},50).wait(343));

	// CamryOut
	this.instance_16 = new lib.CY_AnimationOut_mc();
	this.instance_16.setTransform(277.05,260.6,0.1625,0.1625,0,0,0,150.5,125.2);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(199).to({_off:false},0).to({regX:150.2,regY:125.5,scaleX:0.1833,scaleY:0.1833,x:475.5,y:271.85},44,cjs.Ease.cubicIn).to({_off:true},23).wait(283));

	// CamryIn
	this.instance_17 = new lib.CY_AnimationIn_mc();
	this.instance_17.setTransform(174.9,260.35,0.1345,0.1345,0,0,0,150.2,125.7);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(122).to({_off:false},0).to({regX:150.5,regY:125.2,scaleX:0.1625,scaleY:0.1625,x:277.05,y:260.6},44,cjs.Ease.cubicOut).to({_off:true},33).wait(350));

	// text4
	this.instance_18 = new lib.text4_1();
	this.instance_18.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(441).to({_off:false},0).to({alpha:1},35,cjs.Ease.cubicOut).wait(11).to({alpha:0},32,cjs.Ease.cubicOut).wait(30));

	// text3.1
	this.instance_19 = new lib.text3_1();
	this.instance_19.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(272).to({_off:false},0).to({alpha:1},39,cjs.Ease.cubicOut).wait(107).to({alpha:0},38,cjs.Ease.cubicOut).to({_off:true},1).wait(92));

	// text2
	this.instance_20 = new lib.text2_1();
	this.instance_20.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(102).to({_off:false},0).to({alpha:1},38,cjs.Ease.cubicOut).wait(113).to({alpha:0},39,cjs.Ease.cubicOut).to({_off:true},1).wait(256));

	// text1
	this.instance_21 = new lib.text1_1();
	this.instance_21.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(83).to({alpha:0},39,cjs.Ease.cubicOut).wait(427));

	// frame
	this.instance_22 = new lib.whiteFrame_1();
	this.instance_22.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(549));

	// HI_side
	this.instance_23 = new lib.HI_side_1();
	this.instance_23.setTransform(150,268,1,1,0,0,0,150,125);
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(371).to({_off:false},0).to({_off:true},36).wait(142));

	// CY_side
	this.instance_24 = new lib.CY_side_1();
	this.instance_24.setTransform(150,268,1,1,0,0,0,150,125);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(336).to({_off:false},0).to({_off:true},35).wait(178));

	// backGrey
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D7D9D8").s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
	this.shape_1.setTransform(150,299.9992,1,2.4);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(549));

	// Layer_12
	this.offer_mc_1 = new lib.offer_mc();
	this.offer_mc_1.name = "offer_mc_1";
	this.offer_mc_1.setTransform(150,109,1,1,0,0,0,93,44);

	this.timeline.addTween(cjs.Tween.get(this.offer_mc_1).to({_off:true},97).wait(452));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112,299,693,302);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CL.png?1598571587469", id:"CL"},
		{src:"images/CL_side.png?1598571587469", id:"CL_side"},
		{src:"images/CL_wheel.png?1598571587469", id:"CL_wheel"},
		{src:"images/cta.png?1598571587469", id:"cta"},
		{src:"images/CY.png?1598571587469", id:"CY"},
		{src:"images/CY_side.jpg?1598571587469", id:"CY_side"},
		{src:"images/CY_wheel.png?1598571587469", id:"CY_wheel"},
		{src:"images/details.png?1598571587469", id:"details"},
		{src:"images/eventEnds.png?1598571587469", id:"eventEnds"},
		{src:"images/eventLogo.png?1598571587469", id:"eventLogo"},
		{src:"images/HI.png?1598571587469", id:"HI"},
		{src:"images/HI_side.jpg?1598571587469", id:"HI_side"},
		{src:"images/HI_wheel.png?1598571587469", id:"HI_wheel"},
		{src:"images/logo.png?1598571587469", id:"logo"},
		{src:"images/offerTitle.png?1598571587469", id:"offerTitle"},
		{src:"images/options.png?1598571587469", id:"options"},
		{src:"images/RV.png?1598571587469", id:"RV"},
		{src:"images/RV_side.png?1598571587469", id:"RV_side"},
		{src:"images/RV_wheel.png?1598571587469", id:"RV_wheel"},
		{src:"images/text1.png?1598571587469", id:"text1"},
		{src:"images/text2.png?1598571587469", id:"text2"},
		{src:"images/text3.png?1598571587469", id:"text3"},
		{src:"images/text4.png?1598571587469", id:"text4"},
		{src:"images/whiteFrame.png?1598571587469", id:"whiteFrame"}
	],
	preloads: []
};
