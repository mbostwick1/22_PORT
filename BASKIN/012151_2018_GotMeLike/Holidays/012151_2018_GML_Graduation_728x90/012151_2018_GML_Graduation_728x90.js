...
// stage content:
(lib._012151_2018_GML_Graduation_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// danceGuy3
	this.dance3 = new lib.DanceGuy();
	this.dance3.name = "dance3";
	this.dance3.parent = this;
	this.dance3.setTransform(479.5,135,1,1,0,0,0,364,45);
	this.dance3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.dance3).wait(119).to({_off:false},0).to({x:477.5,y:45},61,cjs.Ease.quadOut).wait(711));

	// danceGuy2
	this.dance2 = new lib.DanceGuy();
	this.dance2.name = "dance2";
	this.dance2.parent = this;
	this.dance2.setTransform(420,134,1,1,0,0,0,364,45);
	this.dance2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.dance2).wait(119).to({_off:false},0).to({y:45},61,cjs.Ease.quadOut).wait(711));
	...
	this.timeline.addTween(cjs.Tween.get(this.dance1).wait(119).to({_off:false},0).to({x:362,y:45},61,cjs.Ease.quadOut).wait(711));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(22).to({_off:false},0).to({x:364},36,cjs.Ease.cubicOut).wait(833));

	// text2
	this.instance_1 = new lib.text2_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(104.1,-21.9,1,1,-32.2,0,0,104,75);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(22).to({_off:false},0).to({rotation:0.4,x:104,y:76},50,cjs.Ease.quartIn).to({rotation:0,y:75},3,cjs.Ease.cubicIn).wait(816));

	// text1
	this.instance_2 = new lib.text1_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(384.9,-11,1,1,26.4,0,0,383.9,35);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(33).to({_off:false},0).to({regX:384,rotation:-0.4,x:384,y:36},50,cjs.Ease.quartIn).to({rotation:0,y:35},3,cjs.Ease.cubicIn).wait(805));

	// logo
	this.instance_3 = new lib.logo_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(48,45,0.422,0.422,0,0,0,48,45);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:1,scaleY:1,alpha:1},58,cjs.Ease.elasticOut).wait(833));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(891));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1522868438637", id:"back"},
		{src:"images/cake.png?1522868438637", id:"cake"},
		{src:"images/dance1.png?1522868438637", id:"dance1"},
		{src:"images/dance2.png?1522868438637", id:"dance2"},
		{src:"images/logo.png?1522868438637", id:"logo"},
		{src:"images/text1.png?1522868438637", id:"text1"},
		{src:"images/text2.png?1522868438637", id:"text2"}
	],
	preloads: []
};
