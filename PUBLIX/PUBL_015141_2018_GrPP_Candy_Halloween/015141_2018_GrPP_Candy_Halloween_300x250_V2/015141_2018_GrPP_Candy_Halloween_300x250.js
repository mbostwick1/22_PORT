...
}).prototype = getMCSymbolPrototype(lib.candy_1, new cjs.Rectangle(0,0,300,250), null);
...
// stage content:
(lib._015141_2018_GrPP_Candy_Halloween_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.clickTag.setTransform(150,125,1.875,0.417,0,0,0,80,300);
	...
	this.kitty_mc.setTransform(70,134,0.308,0.308,0,0,0,184.7,270.8);
	...
	this.instance.parent = this;
	this.instance.setTransform(211.1,185.1,0.4,0.4,0,0,0,211,185);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(124).to({_off:false},0).to({scaleX:1,scaleY:1,x:211,y:185,alpha:1},35,cjs.Ease.elasticOut).wait(3));

	// candy
	this.instance_1 = new lib.candy_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(253,300,1,1,0,0,0,80,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(35).to({_off:false},0).to({x:80},35,cjs.Ease.quartOut).wait(1).to({x:245},35,cjs.Ease.quartOut).wait(56));
	...
	this.instance_3.setTransform(260,300,1,1,0,0,0,80,300);
...
p.nominalBounds = new cjs.Rectangle(149,124,481,252);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905189590", id:"back"},
		{src:"images/candy.png?1537905189590", id:"candy"},
		{src:"images/cta.png?1537905189590", id:"cta"},
		{src:"images/logo.png?1537905189590", id:"logo"},
		{src:"images/text1.png?1537905189590", id:"text1"},
		{src:"images/text2.png?1537905189590", id:"text2"}
	],
	preloads: []
};
