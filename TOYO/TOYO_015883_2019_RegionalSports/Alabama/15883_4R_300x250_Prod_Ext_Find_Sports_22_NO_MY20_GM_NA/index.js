...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("AoTLVIAAowMAmQAAAIAAIwgA99j0IAAngMAmRAAAIAAHgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:119.75,y:96.525}).wait(25).to({graphics:null,x:0,y:0}).wait(211));
	...
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("AoTL9IAAowMAmQAAAIAAIwgA99kcIAAngMAmRAAAIAAHgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:119.75,y:147.525}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(146.2,125,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:139.2},0).wait(4).to({x:157.2},0).wait(6).to({x:136.2,alpha:0.7891},0).wait(4).to({x:146.2,alpha:1},0).to({_off:true},7).wait(211));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596151391904", id:"back1"},
		{src:"images/back2.jpg?1596151391904", id:"back2"},
		{src:"images/cta.png?1596151391904", id:"cta"},
		{src:"images/headline11.png?1596151391904", id:"headline11"},
		{src:"images/headline12.png?1596151391904", id:"headline12"},
		{src:"images/headline21.png?1596151391904", id:"headline21"},
		{src:"images/headline22.png?1596151391904", id:"headline22"},
		{src:"images/headline31.png?1596151391904", id:"headline31"},
		{src:"images/headline32.png?1596151391904", id:"headline32"},
		{src:"images/headline33.png?1596151391904", id:"headline33"},
		{src:"images/logo.png?1596151391904", id:"logo"},
		{src:"images/player.jpg?1596151391904", id:"player"},
		{src:"images/runner.png?1596151391904", id:"runner"},
		{src:"images/text1.png?1596151391904", id:"text1"},
		{src:"images/text2.png?1596151391904", id:"text2"},
		{src:"images/toyota.png?1596151391904", id:"toyota"}
	],
	preloads: []
};
