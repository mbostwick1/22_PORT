...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AiGGuIAAhkIW9AAIAABkg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:133.5,y:43}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AreAyIAAhjIW9AAIAABjg");
	var mask_1_graphics_22 = new cjs.Graphics().p("AreAyIAAhjIW9AAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:193.5,y:71}).wait(22).to({graphics:mask_1_graphics_22,x:193.5,y:71}).wait(13).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("AurFPIAAigMAi/AAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:130,y:33.5}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("AxfBQIAAifMAi/AAAIAACfg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:148,y:43}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Au6BuIAAjbId1AAIAADbg");
	mask.setTransform(166.5,49);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("ApXGVIAAjcId1AAIAADcg");
	mask_1.setTransform(131,40.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1605816138478", id:"back1"},
		{src:"images/back2.jpg?1605816138478", id:"back2"},
		{src:"images/cta.png?1605816138478", id:"cta"},
		{src:"images/headline11.png?1605816138478", id:"headline11"},
		{src:"images/headline12.png?1605816138478", id:"headline12"},
		{src:"images/headline21.png?1605816138478", id:"headline21"},
		{src:"images/headline22.png?1605816138478", id:"headline22"},
		{src:"images/headline31.png?1605816138478", id:"headline31"},
		{src:"images/headline32.png?1605816138478", id:"headline32"},
		{src:"images/headline33.png?1605816138478", id:"headline33"},
		{src:"images/logo.png?1605816138478", id:"logo"},
		{src:"images/player.jpg?1605816138478", id:"player"},
		{src:"images/runner.png?1605816138478", id:"runner"},
		{src:"images/text1.png?1605816138478", id:"text1"},
		{src:"images/text2.png?1605816138478", id:"text2"},
		{src:"images/toyota.png?1605816138478", id:"toyota"}
	],
	preloads: []
};
