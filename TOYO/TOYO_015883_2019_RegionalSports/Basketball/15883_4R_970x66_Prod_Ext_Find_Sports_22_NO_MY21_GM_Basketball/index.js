...
}).prototype = getMCSymbolPrototype(lib.headline32_1, new cjs.Rectangle(0,0,970,66), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AwUA8IAAh3MAgpAAAIAAB3g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:585.45,y:51.15}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AwUA8IAAh3MAgpAAAIAAB3g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:585.45,y:39.15}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AwUBUIAAinMAgpAAAIAACng");
	mask.setTransform(628.6,35.55);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("AwUBUIAAinMAgpAAAIAACng");
	mask_1.setTransform(628.6,51.625);
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("Egv4AEdIAAo5MAq4AAAIAAI5gAAgEaIAAoIMAvZAAAIAAIIg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:657,y:3.875}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(525.55,93.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({regX:164.3,x:521.85},0).wait(9).to({regX:164.2,x:525.55},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("Egv4AEcIAAo4MAq4AAAIAAI4gAAgDtIAAoJMAvZAAAIAAIJg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:657,y:59.6}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(525.55,93.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({regX:164.3,x:519.1},0).wait(4).to({x:535.85},0).wait(6).to({regX:164.4,x:516.4,alpha:0.7891},0).wait(4).to({regX:164.2,x:525.55,alpha:1},0).to({_off:true},7).wait(211));
	...
	this.instance_13.setTransform(129.7,143.05,1.106,1.106,0,0,0,149.8,124.8);
	...
	var mask_6_graphics_34 = new cjs.Graphics().p("AouD2IAAnrMBUQAAAIAAHrg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:mask_6_graphics_0,x:731.15,y:27.325}).wait(34).to({graphics:mask_6_graphics_34,x:483.3517,y:-14.6062}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_top
	this.instance_18 = new lib.text1_1();
	this.instance_18.setTransform(665.45,103.35,0.745,0.745,0,0,0,251.6,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(12).to({x:667.7,alpha:0.8594},0).wait(4).to({x:663.95,alpha:1},0).wait(6).to({x:661.7},0).wait(3).to({x:665.45},0).wait(9).to({x:635.05,y:63.05},0).to({_off:true},16).wait(408));

	// mask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_0 = new cjs.Graphics().p("EgqAADsIAAnXMBUBAAAIAAHXg");
	var mask_7_graphics_34 = new cjs.Graphics().p("AouEjIAAnrMBUQAAAIAAHrg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:mask_7_graphics_0,x:731.15,y:73.6}).wait(34).to({graphics:mask_7_graphics_34,x:483.3517,y:29.0634}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_bottom
	this.instance_19 = new lib.text1_1();
	this.instance_19.setTransform(665.45,103.35,0.745,0.745,0,0,0,251.6,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(10).to({x:650.55},0).wait(5).to({x:704.95,alpha:0.7305},0).wait(5).to({x:643.1,alpha:1},0).wait(5).to({x:665.45},0).wait(9).to({x:635.05,y:63.05},0).wait(5).to({x:611.25},0).wait(7).to({x:649.95,alpha:0.7305},0).to({_off:true},4).wait(408));
...
p.nominalBounds = new cjs.Rectangle(421,2.9,660.5999999999999,88.89999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1605816210250", id:"back1"},
		{src:"images/back2.jpg?1605816210250", id:"back2"},
		{src:"images/cta.png?1605816210250", id:"cta"},
		{src:"images/headline11.png?1605816210250", id:"headline11"},
		{src:"images/headline12.png?1605816210250", id:"headline12"},
		{src:"images/headline21.png?1605816210250", id:"headline21"},
		{src:"images/headline22.png?1605816210250", id:"headline22"},
		{src:"images/headline31.png?1605816210250", id:"headline31"},
		{src:"images/headline32.png?1605816210250", id:"headline32"},
		{src:"images/headline33.png?1605816210250", id:"headline33"},
		{src:"images/logo.png?1605816210250", id:"logo"},
		{src:"images/player.jpg?1605816210250", id:"player"},
		{src:"images/runner.png?1605816210250", id:"runner"},
		{src:"images/text1.png?1605816210250", id:"text1"},
		{src:"images/text2.png?1605816210250", id:"text2"},
		{src:"images/toyota.png?1605816210250", id:"toyota"}
	],
	preloads: []
};
