...
p.nominalBounds = new cjs.Rectangle(0,0,600,174);
...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(0,0,300,50), null);
...
}).prototype = getMCSymbolPrototype(lib.text1_1, new cjs.Rectangle(0,0,300,50), null);
...
}).prototype = getMCSymbolPrototype(lib.candy_1, new cjs.Rectangle(0,0,300,87), null);
...
// stage content:
(lib._015141_2018_GrPP_Candy_Halloween_300x50 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.kitty_mc.setTransform(270.1,28.4,0.117,0.117,0,0,0,185.1,271.4);

	this.timeline.addTween(cjs.Tween.get(this.kitty_mc).wait(135).to({x:270,y:100},35,cjs.Ease.quintOut).wait(7));

	// candy
	this.instance_1 = new lib.candy_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(80,211,1,1,0,0,0,80,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(36).to({_off:false},0).to({y:286},51,cjs.Ease.quartOut).wait(1).to({y:350},35,cjs.Ease.quartOut).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:300},35,cjs.Ease.quartOut).wait(1).to({y:359,alpha:0},51,cjs.Ease.quartOut).wait(90));
...
p.nominalBounds = new cjs.Rectangle(149,-65,729,180);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1537905207695", id:"back"},
		{src:"images/candy.png?1537905207695", id:"candy"},
		{src:"images/cta.png?1537905207695", id:"cta"},
		{src:"images/logo.png?1537905207695", id:"logo"},
		{src:"images/text1.png?1537905207695", id:"text1"},
		{src:"images/text2.png?1537905207695", id:"text2"}
	],
	preloads: []
};
