...
p.nominalBounds = new cjs.Rectangle(0,0,527,264);
...
p.nominalBounds = new cjs.Rectangle(0,0,784,180);


(lib.hand = function() {
	this.initialize(img.hand);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,750,355);
...
(lib.offer_mc = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(-23.75,13.125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// dynamic_field1
	this.dynamic_field1 = new cjs.Text("199", "31px 'Toyota Type Book'");
	...
	this.dynamic_field1.setTransform(-50.4775,-7.05,1.1202,1.0991);
	...
	this.dynamic_field2.lineWidth = 121;
	this.dynamic_field2.parent = this;
	this.dynamic_field2.setTransform(15.2427,5.2,1.1202,1.0991);
	...
	this.dynamic_field3.lineWidth = 104;
	this.dynamic_field3.parent = this;
	this.dynamic_field3.setTransform(16.2286,15.2,1.1202,1.0991);

	this.timeline.addTween(cjs.Tween.get(this.dynamic_field3).wait(1));

	// dynamic_field4
	this.dynamic_field4 = new cjs.Text("PLUS $500 BONUS CASH", "bold 8px 'Toyota Type Black'");
	...
	this.dynamic_field4.setTransform(15.2321,35.2,1.1202,1.0991);

	this.timeline.addTween(cjs.Tween.get(this.dynamic_field4).wait(1));

}).prototype = getMCSymbolPrototype(lib.offer_mc, new cjs.Rectangle(-58.7,-9.2,257.7,60.7), null);
...
(lib.hand_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-150,-171.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.hand_1, new cjs.Rectangle(-150,-171.5,375,177.5), null);
...
}).prototype = getMCSymbolPrototype(lib.endframe_1, new cjs.Rectangle(0,0,392,90), null);
...
}).prototype = getMCSymbolPrototype(lib.corollaLogo_1, new cjs.Rectangle(0,0,728,90), null);
...
(lib.car_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-174,-280,0.58,0.58);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.car_1, new cjs.Rectangle(-174,-280,305.7,153.1), null);
...
(lib.black = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("A/PHHIAAuNMA+fAAAIAAONg");
	this.shape.setTransform(200,45.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.black, new cjs.Rectangle(0,0,400,91), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(183).call(this.frame_184).wait(43).call(this.frame_227).wait(49).call(this.frame_276).wait(28).call(this.frame_304).wait(28).call(this.frame_332).wait(28).call(this.frame_360).wait(1));
	...
	this.details_btn.setTransform(438.05,68,1.5555,0.7143,0,0,0,18.2,7);
	this.details_btn._off = true;
	new cjs.ButtonHelper(this.details_btn, 0, 1, 2, false, new lib.details_btn(), 3);

	this.timeline.addTween(cjs.Tween.get(this.details_btn).wait(332).to({_off:false},0).wait(29));
	...
	this.instance.parent = this;
	this.instance.setTransform(150,126,1,1,0,0,0,150,125);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(332).to({_off:false},0).to({alpha:1},28,cjs.Ease.quadOut).wait(1));

	// options copy
	this.instance_1 = new lib.options_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(791,125,1,1,0,0,0,150,125);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(332).to({_off:false},0).to({alpha:1},28,cjs.Ease.quadOut).wait(1));

	// cta
	this.instance_2 = new lib.cta_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(270,125,1,1,0,0,0,150,125);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(304).to({_off:false},0).to({x:150},28,cjs.Ease.quadOut).wait(29));

	// offer_mc
	this.offer_mc = new lib.offer_mc();
	this.offer_mc.name = "offer_mc";
	this.offer_mc.parent = this;
	this.offer_mc.setTransform(553.75,69.25,1,1,0,0,0,93,44);
	this.offer_mc.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.offer_mc).wait(276).to({alpha:1},28,cjs.Ease.quadOut).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(276).to({_off:false},0).to({alpha:1},28,cjs.Ease.quadOut).wait(57));

	// text4
	this.instance_4 = new lib.text4_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-45,125,1,1,0,0,0,150,125);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(249).to({_off:false},0).to({x:150},27,cjs.Ease.cubicOut).wait(85));

	// text3
	this.instance_5 = new lib.text3_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-63,125,1,1,0,0,0,150,125);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(227).to({_off:false},0).to({x:150},27,cjs.Ease.cubicOut).wait(107));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(205).to({_off:false},0).to({alpha:1},22,cjs.Ease.cubicInOut).wait(134));

	// text2
	this.instance_7 = new lib.text2_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(344,125,1,1,0,0,0,150,125);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(130).to({_off:false},0).to({x:150},29,cjs.Ease.cubicOut).wait(25).to({alpha:0},24,cjs.Ease.cubicInOut).to({_off:true},1).wait(152));

	// text1
	this.instance_8 = new lib.text1_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(220,265,1,1,0,0,0,150,125);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(71).to({_off:false},0).to({y:125,alpha:1},44,cjs.Ease.cubicOut).wait(24).to({x:150},20,cjs.Ease.cubicOut).wait(25).to({alpha:0},24,cjs.Ease.cubicInOut).to({_off:true},1).wait(152));

	// whiteR
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A6UHCIAAuDMA0pAAAIAAODg");
	this.shape_1.setTransform(568.5,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(193).to({x:568.1667},0).wait(1).to({x:567.8333},0).wait(1).to({x:567.5},0).wait(1).to({x:567.1667},0).wait(1).to({x:566.8333},0).wait(1).to({x:566.5},0).wait(1).to({x:566.1667},0).wait(1).to({x:565.8333},0).wait(1).to({x:565.5},0).wait(1).to({x:565.1667},0).wait(1).to({x:564.8333},0).wait(1).to({x:564.5},0).wait(1).to({x:564.1667},0).wait(1).to({x:563.8333},0).wait(1).to({x:563.5},0).wait(1).to({x:563.1667},0).wait(1).to({x:562.8333},0).wait(1).to({x:562.5},0).wait(1).to({x:562.1667},0).wait(1).to({x:561.8333},0).wait(1).to({x:561.5},0).wait(1).to({x:561.1667},0).wait(1).to({x:560.8333},0).wait(1).to({x:560.5},0).wait(145));

	// endframe
	this.instance_9 = new lib.endframe_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(205).to({_off:false},0).to({alpha:1},22,cjs.Ease.quadOut).wait(134));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(184).to({_off:false},0).to({alpha:1},24).wait(153));

	// options
	this.instance_11 = new lib.options_1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(361));

	// corollaLogo
	this.instance_12 = new lib.corollaLogo_1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(361));

	// whiteL
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AqdHCIAAuDIU7AAIAAODg");
	this.shape_2.setTransform(67,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(361));

	// hand
	this.instance_13 = new lib.hand_1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(285.1,56.95,0.7323,0.7323,0,0,0,55.9,-68.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(1).to({regX:56.1,regY:-68.8,scaleX:1.0465,scaleY:1.0465,x:269.25,y:67.9},183,cjs.Ease.cubicInOut).wait(177));

	// car
	this.instance_14 = new lib.car_1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(317.05,98.05,0.9368,0.9368,0,0,0,50.1,-150.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(1).to({regX:50.2,regY:-150.8,scaleX:0.7473,scaleY:0.7473,x:285.1,y:75.95},183,cjs.Ease.cubicInOut).wait(177));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(151,5.5,1218,224.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/car.jpg?1567629964974", id:"car"},
		{src:"images/corollaLogo.png?1567629964974", id:"corollaLogo"},
		{src:"images/cta.png?1567629964974", id:"cta"},
		{src:"images/details.png?1567629964974", id:"details"},
		{src:"images/endframe.jpg?1567629964974", id:"endframe"},
		{src:"images/hand.png?1567629964974", id:"hand"},
		{src:"images/logo.png?1567629964974", id:"logo"},
		{src:"images/offerTitle.png?1567629964974", id:"offerTitle"},
		{src:"images/options.png?1567629964974", id:"options"},
		{src:"images/text1.png?1567629964974", id:"text1"},
		{src:"images/text2.png?1567629964974", id:"text2"},
		{src:"images/text3.png?1567629964974", id:"text3"},
		{src:"images/text4.png?1567629964974", id:"text4"}
	],
	preloads: []
};
