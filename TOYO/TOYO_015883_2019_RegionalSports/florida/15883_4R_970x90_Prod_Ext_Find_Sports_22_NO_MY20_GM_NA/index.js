...
p.nominalBounds = new cjs.Rectangle(0,0,1177,500);


(lib.text2 = function() {
	this.initialize(img.text2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,990,225);
...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(0,0,495,112.5), null);
...
}).prototype = getMCSymbolPrototype(lib.text1_1, new cjs.Rectangle(0,0,588.5,250), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A/dB5IAAjyMA+7AAAIAADyg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:623.575,y:71.65}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A/dB5IAAjyMA+7AAAIAADyg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:623.575,y:47.35}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("AN1D/IAAigMAo8AAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:350.525,y:25.5}).wait(163).to({graphics:null,x:0,y:0}).wait(1));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("AN1CvIAAigMAo8AAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:350.525,y:17.5}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A7EB+IAAj7MA2JAAAIAAD7g");
	mask.setTransform(644.7,45.725);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A7EB9IAAj5MA2JAAAIAAD5g");
	mask_1.setTransform(644.7,69.775);
...
(lib.headline1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EgmhABuIAAjbMBNDAAAIAADbg");
	mask.setTransform(667.45,47);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("EgmhABuIAAjbMBNDAAAIAADbg");
	mask_1.setTransform(667.45,69);
...
(lib.back2_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.0222,scaleY:1.0222,x:151.35,y:120.85},480).wait(1));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(170,125,1,1,0,0,0,150,125);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(357).to({_off:false},0).to({regX:150.3,scaleX:0.9901,scaleY:0.9887,x:170.3,y:125.05},100,cjs.Ease.quadOut).wait(1));
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("Eg6sAEdIAAo5MB1ZAAAIAAI5g");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:798.275,y:18.875}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(597.55,108.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({regX:164.3,x:593.85},0).wait(9).to({regX:164.2,x:597.55},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("Eg6sAEcIAAo3MB1ZAAAIAAI3g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:798.275,y:74.6}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(597.55,108.4,0.9302,0.9302,0,0,0,164.2,124.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({regX:164.3,x:591.1},0).wait(4).to({x:607.85},0).wait(6).to({regX:164.4,x:588.4,alpha:0.7891},0).wait(4).to({regX:164.2,x:597.55,alpha:1},0).to({_off:true},7).wait(211));
	...
	mask_6._off = true;
	var mask_6_graphics_0 = new cjs.Graphics().p("EgqAADsIAAnXMBUCAAAIAAHXg");
	var mask_6_graphics_34 = new cjs.Graphics().p("Ar2D2IAAnrMBUQAAAIAAHrg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:mask_6_graphics_0,x:761.15,y:47.325}).wait(34).to({graphics:mask_6_graphics_34,x:463.35,y:-4.6}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_top
	this.instance_18 = new lib.text1_1();
	this.instance_18.setTransform(755.45,63.35,0.745,0.745,0,0,0,251.6,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(12).to({x:757.7,alpha:0.8594},0).wait(4).to({x:753.95,alpha:1},0).wait(6).to({x:751.7},0).wait(3).to({x:755.45},0).wait(9).to({x:605.05,y:13.05},0).to({_off:true},16).wait(408));

	// mask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_0 = new cjs.Graphics().p("EgqAADsIAAnXMBUCAAAIAAHXg");
	var mask_7_graphics_34 = new cjs.Graphics().p("Ar2FVIAAnrMBUQAAAIAAHrg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:mask_7_graphics_0,x:761.15,y:93.6}).wait(34).to({graphics:mask_7_graphics_34,x:463.35,y:34.075}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_bottom
	this.instance_19 = new lib.text1_1();
	this.instance_19.setTransform(755.45,63.35,0.745,0.745,0,0,0,251.6,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(10).to({x:740.55},0).wait(5).to({x:794.95,alpha:0.7305},0).wait(5).to({x:733.1,alpha:1},0).wait(5).to({x:755.45},0).wait(9).to({x:605.05,y:13.05},0).wait(5).to({x:581.25},0).wait(7).to({x:619.95,alpha:0.7305},0).to({_off:true},4).wait(408));
...
p.nominalBounds = new cjs.Rectangle(421,15.9,660.5999999999999,101.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1596148135913", id:"back1"},
		{src:"images/back2.jpg?1596148135913", id:"back2"},
		{src:"images/cta.png?1596148135913", id:"cta"},
		{src:"images/headline11.png?1596148135913", id:"headline11"},
		{src:"images/headline12.png?1596148135913", id:"headline12"},
		{src:"images/headline21.png?1596148135913", id:"headline21"},
		{src:"images/headline22.png?1596148135913", id:"headline22"},
		{src:"images/headline31.png?1596148135913", id:"headline31"},
		{src:"images/headline33.png?1596148135913", id:"headline33"},
		{src:"images/logo.png?1596148135913", id:"logo"},
		{src:"images/player.jpg?1596148135913", id:"player"},
		{src:"images/runner.png?1596148135913", id:"runner"},
		{src:"images/text1.png?1596148135913", id:"text1"},
		{src:"images/text2.png?1596148135913", id:"text2"},
		{src:"images/toyota.png?1596148135913", id:"toyota"}
	],
	preloads: []
};
