...
}).prototype = getMCSymbolPrototype(lib.back1_image, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.back_image, new cjs.Rectangle(0,0,728,90), null);
...
(lib.headline3 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AtgAyIAAhjIbBAAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:475.5,y:78}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AtgAyIAAhjIbBAAIAABjg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:475.5,y:68}).wait(35).to({graphics:null,x:0,y:0}).wait(129));
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("ADSEsIAAigMApkAAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:287,y:30}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
	...
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("ADSDcIAAigMApkAAAIAACgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:287,y:22}).wait(163).to({graphics:null,x:0,y:0}).wait(1));
...
(lib.headline2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AOxEjIAAkFMAgqAAAIAAEFg");
	mask.setTransform(303.5452,29.1056);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("AOxGgIAAkFMAgqAAAIAAEFg");
	mask_1.setTransform(303.5452,41.5588);
...
p.nominalBounds = new cjs.Rectangle(-8.3,-6.9,768.6999999999999,95.10000000000001);
...
p.nominalBounds = new cjs.Rectangle(-40.9,-2.8,803.1999999999999,99.39999999999999);
...
(lib.index = function(mode,startPosition,loop) {
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_222 = new cjs.Graphics().p("EgslAEyIAApjMAuEAAAIAAJjgAHbEvIAAovMAy8AAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_2_graphics_222,x:373.5,y:16.7}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_top
	this.instance_9 = new lib.text2_1();
	this.instance_9.setTransform(276.2,113,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(222).to({_off:false},0).wait(9).to({x:272.2},0).wait(9).to({x:276.2},0).to({_off:true},7).wait(211));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_222 = new cjs.Graphics().p("EgslAIYIAApjMAuEAAAIAAJjgAHbHkIAAovMAy8AAAIAAIvg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(222).to({graphics:mask_3_graphics_222,x:373.5,y:53.6}).wait(25).to({graphics:null,x:0,y:0}).wait(211));

	// text2_bottom
	this.instance_10 = new lib.text2_1();
	this.instance_10.setTransform(276.2,113,1,1,0,0,0,164.2,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(222).to({_off:false},0).wait(4).to({x:269.2},0).wait(4).to({x:287.2},0).wait(6).to({x:266.2,alpha:0.7891},0).wait(4).to({x:276.2,alpha:1},0).to({_off:true},7).wait(211));
	...
	this.instance_13.setTransform(138.7,143.05,1.106,1.106,0,0,0,149.8,124.8);
	...
	mask_6._off = true;
	var mask_6_graphics_0 = new cjs.Graphics().p("Eg4ZAE9IAAp5MBwzAAAIAAJ5g");
	var mask_6_graphics_34 = new cjs.Graphics().p("A8FFKIAAqTMBxFAAAIAAKTg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:mask_6_graphics_0,x:491,y:17.2}).wait(34).to({graphics:mask_6_graphics_34,x:543.975,y:19.025}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_top
	this.instance_18 = new lib.text1_1();
	this.instance_18.setTransform(402.75,119.25,1,1,0,0,0,251.5,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(12).to({x:405.75,alpha:0.8594},0).wait(4).to({x:400.75,alpha:1},0).wait(6).to({x:397.75},0).wait(3).to({x:402.75},0).wait(9).to({x:642.75,y:123.2},0).to({_off:true},16).wait(408));

	// mask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_0 = new cjs.Graphics().p("Eg4ZAE9IAAp5MBwzAAAIAAJ5g");
	var mask_7_graphics_34 = new cjs.Graphics().p("A8FJHIAAqSMBxFAAAIAAKSg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:mask_7_graphics_0,x:491,y:79.325}).wait(34).to({graphics:mask_7_graphics_34,x:543.975,y:58.325}).wait(16).to({graphics:null,x:0,y:0}).wait(408));

	// text1_bottom
	this.instance_19 = new lib.text1_1();
	this.instance_19.setTransform(402.75,119.25,1,1,0,0,0,251.5,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(10).to({x:382.75},0).wait(5).to({x:455.75,alpha:0.7305},0).wait(5).to({x:372.75,alpha:1},0).wait(5).to({x:402.75},0).wait(9).to({x:642.75,y:123.2},0).wait(5).to({x:610.75},0).wait(7).to({x:662.75,alpha:0.7305},0).to({_off:true},4).wait(408));

	// mask (mask)
	var mask_8 = new cjs.Shape();
	mask_8._off = true;
	var mask_8_graphics_152 = new cjs.Graphics().p("AxKEuIAApbMAiUAAAIAAJbg");
	var mask_8_graphics_156 = new cjs.Graphics().p("AxKEuIAApbMAiVAAAIAAJbg");
	var mask_8_graphics_164 = new cjs.Graphics().p("AxJG3IAAttMAiTAAAIAANtg");
	var mask_8_graphics_169 = new cjs.Graphics().p("AxJCBIAAkBMAiTAAAIAAEBg");
	var mask_8_graphics_175 = new cjs.Graphics().p("AxKEoIAApQMAiUAAAIAAJQg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(152).to({graphics:mask_8_graphics_152,x:242.7,y:27.35}).wait(4).to({graphics:mask_8_graphics_156,x:354.15,y:58.375}).wait(8).to({graphics:mask_8_graphics_164,x:323.475,y:50}).wait(5).to({graphics:mask_8_graphics_169,x:266.125,y:45.8}).wait(6).to({graphics:mask_8_graphics_175,x:237.85,y:69.45}).wait(283));

	// back1
	this.instance_20 = new lib.back_image();
	this.instance_20.setTransform(153.05,145.95,1.1521,1.1521,0,0,0,150,125);
...
p.nominalBounds = new cjs.Rectangle(300,33,788,74.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1605816186685", id:"back1"},
		{src:"images/back2.jpg?1605816186685", id:"back2"},
		{src:"images/cta.png?1605816186685", id:"cta"},
		{src:"images/headline11.png?1605816186685", id:"headline11"},
		{src:"images/headline12.png?1605816186685", id:"headline12"},
		{src:"images/headline21.png?1605816186685", id:"headline21"},
		{src:"images/headline22.png?1605816186685", id:"headline22"},
		{src:"images/headline31.png?1605816186685", id:"headline31"},
		{src:"images/headline32.png?1605816186685", id:"headline32"},
		{src:"images/headline33.png?1605816186685", id:"headline33"},
		{src:"images/logo.png?1605816186685", id:"logo"},
		{src:"images/player.jpg?1605816186685", id:"player"},
		{src:"images/runner.png?1605816186685", id:"runner"},
		{src:"images/text1.png?1605816186685", id:"text1"},
		{src:"images/text2.png?1605816186685", id:"text2"},
		{src:"images/toyota.png?1605816186685", id:"toyota"}
	],
	preloads: []
};
